...
public class MoonUtils {
     ...
     */
    public static void replaceEmoticons(Context context, Editable editable, Editable editable1, int start, int count) {
        if (count <= 0 || editable.length() < start + count)
            return;

        //editable1.clearSpans();
        ...
        while (matcher.find()) {
            ...
            if (d != null) {
                ...
                editable1.setSpan(span, from, to, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
