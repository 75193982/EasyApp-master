...
public class PluginAdapter {
    ...
    private void initView(Context context, ViewGroup viewGroup) {
        ...
        this.mPluginPager = (ViewGroup)this.mLayoutInflater.inflate(io.rong.imkit.R.layout.rc_ext_plugin_pager, (ViewGroup)null);
        Integer height = (int)context.getResources().getDimension(io.rong.imkit.R.dimen.rc_extension_board_height);
        this.mPluginPager.setLayoutParams(new RelativeLayout.LayoutParams(-1, height));
        ...
        this.mViewPager = (ViewPager)this.mPluginPager.findViewById(io.rong.imkit.R.id.rc_view_pager);
        this.mIndicator = (LinearLayout)this.mPluginPager.findViewById(io.rong.imkit.R.id.rc_indicator);
    ...
    public int getVisibility() {
        return this.mPluginPager != null ? this.mPluginPager.getVisibility() : View.GONE;
    }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
           ...
           PluginAdapter.PluginItemAdapter.ViewHolder holder;
            if (convertView == null) {
                ...
                convertView = PluginAdapter.this.mLayoutInflater.inflate(io.rong.imkit.R.layout.rc_ext_plugin_item, (ViewGroup)null);
                holder.imageView = (ImageView)convertView.findViewById(io.rong.imkit.R.id.rc_ext_plugin_icon);
                holder.textView = (TextView)convertView.findViewById(io.rong.imkit.R.id.rc_ext_plugin_title);
    ...
    private class PluginPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            GridView gridView = (GridView) PluginAdapter.this.mLayoutInflater.inflate(io.rong.imkit.R.layout.rc_ext_plugin_grid_view, (ViewGroup)null);
