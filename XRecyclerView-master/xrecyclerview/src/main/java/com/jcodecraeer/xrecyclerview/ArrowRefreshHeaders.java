...
public class ArrowRefreshHeaders extends LinearLayout implements BaseRefreshHeader {
	...
	public ArrowRefreshHeaders(Context context) {
		super(context);
		initView();
	}
	 ...
	 * @param attrs
	 */
	public ArrowRefreshHeaders(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
