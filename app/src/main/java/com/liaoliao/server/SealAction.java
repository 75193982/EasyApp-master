...
import com.liaoliao.server.request.AddGroupMemberRequest;
import com.liaoliao.server.request.AddToBlackListRequest;
import com.liaoliao.server.request.AgreeFriendsRequest;
import com.liaoliao.server.request.ChangePasswordRequest;
import com.liaoliao.server.request.CheckPhoneRequest;
import com.liaoliao.server.request.CreateGroupRequest;
import com.liaoliao.server.request.DeleteFriendRequest;
import com.liaoliao.server.request.DeleteGroupMemberRequest;
import com.liaoliao.server.request.DismissGroupRequest;
import com.liaoliao.server.request.FriendInvitationRequest;
import com.liaoliao.server.request.JoinGroupRequest;
import com.liaoliao.server.request.LoginRequest;
import com.liaoliao.server.request.QuitGroupRequest;
import com.liaoliao.server.request.RegisterRequest;
import com.liaoliao.server.request.RemoveFromBlacklistRequest;
import com.liaoliao.server.request.RestPasswordRequest;
import com.liaoliao.server.request.SendCodeRequest;
import com.liaoliao.server.request.SetFriendDisplayNameRequest;
import com.liaoliao.server.request.SetGroupDisplayNameRequest;
import com.liaoliao.server.request.SetGroupNameRequest;
import com.liaoliao.server.request.SetGroupPortraitRequest;
import com.liaoliao.server.request.SetNameRequest;
import com.liaoliao.server.request.SetPortraitRequest;
import com.liaoliao.server.request.VerifyCodeRequest;
import com.liaoliao.server.response.AddGroupMemberResponse;
import com.liaoliao.server.response.AddToBlackListResponse;
import com.liaoliao.server.response.AgreeFriendsResponse;
import com.liaoliao.server.response.ChangePasswordResponse;
import com.liaoliao.server.response.CheckPhoneResponse;
import com.liaoliao.server.response.CreateGroupResponse;
import com.liaoliao.server.response.DefaultConversationResponse;
import com.liaoliao.server.response.DeleteFriendResponse;
import com.liaoliao.server.response.DeleteGroupMemberResponse;
import com.liaoliao.server.response.DismissGroupResponse;
import com.liaoliao.server.response.FriendInvitationResponse;
import com.liaoliao.server.response.GetBlackListResponse;
import com.liaoliao.server.response.GetFriendInfoByIDResponse;
import com.liaoliao.server.response.GetGroupInfoResponse;
import com.liaoliao.server.response.GetGroupMemberResponse;
import com.liaoliao.server.response.GetGroupResponse;
import com.liaoliao.server.response.GetTokenResponse;
import com.liaoliao.server.response.GetUserInfoByIdResponse;
import com.liaoliao.server.response.GetUserInfoByPhoneResponse;
import com.liaoliao.server.response.GetUserInfosResponse;
import com.liaoliao.server.response.JoinGroupResponse;
import com.liaoliao.server.response.LoginResponse;
import com.liaoliao.server.response.QiNiuTokenResponse;
import com.liaoliao.server.response.QuitGroupResponse;
import com.liaoliao.server.response.RegisterResponse;
import com.liaoliao.server.response.RemoveFromBlackListResponse;
import com.liaoliao.server.response.RestPasswordResponse;
import com.liaoliao.server.response.SendCodeResponse;
import com.liaoliao.server.response.SetFriendDisplayNameResponse;
import com.liaoliao.server.response.SetGroupDisplayNameResponse;
import com.liaoliao.server.response.SetGroupNameResponse;
import com.liaoliao.server.response.SetGroupPortraitResponse;
import com.liaoliao.server.response.SetNameResponse;
import com.liaoliao.server.response.SetPortraitResponse;
import com.liaoliao.server.response.SyncTotalDataResponse;
import com.liaoliao.server.response.UserRelationshipResponse;
import com.liaoliao.server.response.VerifyCodeResponse;
import com.liaoliao.server.response.VersionResponse;
