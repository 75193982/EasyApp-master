...
import com.liaoliao.chat.http.CustomHelper;
...
import com.liaoliao.chat.timchat.model.FriendProfile;
import com.liaoliao.chat.timchat.model.FriendshipInfo;
import com.liaoliao.chat.timchat.model.GroupInfo;
...
import com.liaoliao.chat.timchat.model.UGCMessage;
import com.liaoliao.chat.timchat.model.VideoMessage;
import com.liaoliao.chat.timchat.model.VoiceMessage;
import com.liaoliao.chat.timchat.utils.FileUtil;
...
//        RefreshEvent.getInstance().onRefresh();
        ...
        if (intent_photo.resolveActivity(getPackageManager()) != null) {
            ...
            if (tempFile != null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    fileUri = FileProvider.getUriForFile(MyApplication.getContext(), "com.liaoliao" + ".provider", tempFile);
                    // 给目标应用一个临时授权
                    intent_photo.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    intent_photo.setDataAndType(fileUri, "application/vnd.android.package-archive");
                } else {
    ...
    public void takeSuccess(TResult result) {
        ...
        for (int i = 0; i < result.getImages().size(); i++) {
            Uri uri = Uri.parse(result.getImages().get(i).getCompressPath());
