package com.liaoliao.chat.timchat.model;
...
import com.liaoliao.chat.timchat.ui.customview.CenterImageSpan;
import com.liaoliao.chat.timchat.utils.EmoticonUtil;
...
public class TextMessage extends Message {
    ...
    public TextMessage(Editable s){
        ...
        for (ImageSpan span : listSpans){
            ...
            int index = EmoticonUtil.indexOf(s.subSequence(startIndex, endIndex).toString());
            ...
            switch (elems.get(i).getType()){
                case Face:
                    ...
                    try{
                        ...
                        InputStream is = am.open(String.format("emoji/default/emoji_%d.png", faceElem.getIndex()));
                        if (is == null) continue;
                        ...
                        CenterImageSpan span = new CenterImageSpan(context, resizedBitmap, ImageSpan.ALIGN_BASELINE);
