...
import com.liaoliao.chat.adapter.SessionAdapter;
import com.liaoliao.chat.base.BaseFragmentActivity;
import com.liaoliao.chat.base.BaseFragmentPresenter;
import com.liaoliao.chat.db.DBManager;
import com.liaoliao.chat.db.model.GroupMember;
import com.liaoliao.chat.model.message.RedPacketMessage;
import com.liaoliao.chat.utils.FileOpenUtils;
import com.liaoliao.chat.utils.LogUtils;
import com.liaoliao.chat.utils.MediaFileUtils;
import com.liaoliao.chat.utils.Setting;
import com.liaoliao.chat.utils.UIUtils;
import com.liaoliao.model.data.LocationData;
import com.liaoliao.ui.activity.SessionActivity;
import com.liaoliao.ui.widget.CustomDialog;
...
public class SessionAtPresenter extends BaseFragmentPresenter<ISessionAtView> {
    ...
    public void setAdapter() {
        if (mAdapter == null) {
            ...
            mAdapter.setOnItemLongClickListener((helper, viewGroup, view, position) -> {
                ...
                if (content instanceof RedPacketMessage || !message.getSenderUserId().equalsIgnoreCase(new Setting(App.getContext()).loadString("userId"))) {
    ...
    private void recallMessageAndInsertMessage(RecallNotificationMessage recallNotificationMessage, int position) {
        RongIMClient.getInstance().insertMessage(mConversationType, mSessionId, new Setting(App.getContext()).loadString("userId"), recallNotificationMessage);
        mData.remove(position);
