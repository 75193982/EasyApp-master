...
import com.liaoliao.chat.utils.TimeUtils;
import com.liaoliao.chat.utils.UIUtils;
import com.liaoliao.chat.utils.VideoThumbLoader;
import com.liaoliao.chat.view.SessionAtPresenter;
import com.liaoliao.server.utils.json.JsonMananger;
import com.liaoliao.ui.activity.SessionActivity;
import com.liaoliao.ui.widget.BubbleImageView;
import com.liaoliao.ui.widget.CircularProgressBar;
...
public class SessionAdapter extends LQRAdapterForRecyclerView<Message> {
    ...
    private void setView(LQRViewHolderForRecyclerView helper, Message item, int position) {
        ...
        if (msgContent instanceof TextMessage) {
            ...
            try {
                UserInfo curUserInfo = DBManager.getInstance().getUserInfo(new Setting(App.getContext()).loadString("userId"));
            ...
            String operatorName = "";
            if (operatorId.equalsIgnoreCase(new Setting(App.getContext()).loadString("userId"))) {
