...
public class RecognizePlugin implements IPluginModule, IPluginRequestPermissionResultCallback {
    ...
    public Drawable obtainDrawable(Context context) {
        return context.getResources().getDrawable(io.rong.recognizer.R.drawable.rc_recognizer_voice_selector);
    }

    @Override
    public String obtainTitle(Context context) {
        return context.getString(io.rong.recognizer.R.string.rc_plugin_recognize);
    }
